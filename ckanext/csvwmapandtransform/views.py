...
class CreateMapView(MethodView):
    ...
    def get(self, id: str, resource_id: str):
        ...
        iframe_url=toolkit.url_for('csvwmapandtransform.iframe_maptomethod', id=id, resource_id=resource_id,qualified=True)
        return base.render(
...
blueprint.add_url_rule(
    '/dataset/<id>/resource/<resource_id>/maptomethod',
    view_func=iframe_maptomethod
)
